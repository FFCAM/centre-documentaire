export default function Searchbar() {
    return (
        ...
        <form>
            <div className="flex">
                <label htmlFor="search-dropdown" className="mb-2 text-sm font-medium text-gray-900 sr-only dark:text-white">Quel type d ouvrage ?</label>
                ...
                <div className="relative w-full">
                    <input type="search" id="search-dropdown"
                        ...
                        placeholder="Rechercher dans les livres, cartes, ..." required />
